...
###############################################################################################################
    ...
    if frame_num == 0:
        l_out, r_out, l_in, r_in = 10, -10, -2, 2
    elif steering_angle<0:
        l_out, l_in = 4+int(steering_angle/20), 1+int(steering_angle/10)
        r_out, r_in = -4+int(steering_angle/10), -1+int(steering_angle/10)
    else:
        l_out, l_in = (4+int(steering_angle/10)), 1-int(steering_angle/10)
        r_out, r_in = -4-int(steering_angle/20), -1+int(steering_angle/10)
    print(l_out,l_in,r_out,r_in)
    ...
    if frame_num != 0 and ((abs(pre_steering_angle)<10 and abs(pre_steering_angle - steering_angle)>5) or(abs(pre_steering_angle)>=10 and abs(pre_steering_angle - steering_angle)>10)):
